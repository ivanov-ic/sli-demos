...
| | Demo | Lecture |
|---|---|---|
| L5.1 | [Coulomb against thermal energy](l5-1-coulomb-thermal.html) | Ions in solution |
| L5.2 | [Ionic atmosphere explorer](l5-2-ionic-atmosphere.html) | Ions in solution |
| L6.1 | [Activity coefficient models](l6-1-activity-models.html) | Non-ideality |
| L6.2 | [Counting the free water](l6-2-free-water.html) | Non-ideality |
| L7.1 | [Extrapolating to the limiting value](l7-1-extrapolation.html) | Migration and conductivity |
| L7.2 | [The ion race](l7-2-ion-race.html) | Migration and conductivity |
| L8.1 | [The diffusion clock](l8-1-diffusion-clock.html) | Diffusion and thermal gradients |
| L8.2 | [Thermophoresis and an MST titration](l8-2-thermophoresis-mst.html) | Diffusion and thermal gradients |
...
```html
<iframe src="https://USERNAME.github.io/sli-demos/l5-2-ionic-atmosphere.html"
